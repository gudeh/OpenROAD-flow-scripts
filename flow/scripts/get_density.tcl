...
gui::dump_heatmap Placement "$::env(REPORTS_DIR)/$::env(PLATFORM)-$::env(my_design_name)-stg$::env(STAGE)-Pdensity.csv"
gui::set_display_controls "Heat Maps/Placement Density" visible true
set psName $::env(REPORTS_DIR)/$::env(PLATFORM)-$::env(my_design_name)-stg$::env(STAGE)-Pdensity.png
save_image -width 3000 $psName
