test/test_helper.sh ibex gf180 #high congestion
test/test_helper.sh ibex asap7 #high congestion
test/test_helper.sh ibex ihp-sg13g2 & #low congestion
test/test_helper.sh jpeg sky130hs #low congestion
test/test_helper.sh swerv nangate45 #high congestion
test/test_helper.sh black_parrot nangate45 #high congestion
